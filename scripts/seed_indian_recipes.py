#!/usr/bin/env python
"""Script to seed Indian and Bihari recipes into the database"""
import os
import sys
import django
...
# Get or create demo chef user
demo_user, created = User.objects.get_or_create(
    username='bihari_chef',
    defaults={
...
print(f"\n✓ Seeding complete! {count} new Indian & Bihari recipes added.")
